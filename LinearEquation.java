...
public class LinearEquation {
    ...
    public LinearEquation(int firstX, int secondX, int firstY, int secondY) {
        x1 = firstX;
        x2 = secondX;
        y1 = firstY;
        y2 = secondY;
    ...
    public String equation() {
        String fEquation = "y = ";
        if (x2 == x1) {
          return "This is a vertical line and the equation is: x= " + x1;
        }
        else if (y2 == y1) {
 ...
 + ")";
        ...
        if (x2 == x1) {
          info = "This is a vertical line and the equation is: x = " + x1;
        }
        return info;
    }
